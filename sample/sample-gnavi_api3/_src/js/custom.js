  ...
  */
	{
		(function () {
			...
			var navBtn = '#nav_btn';
			var nav = '.footer-nav';
			var navBody = '.footer-nav__body,.menu > ul';
			var fsn = new fullScreenNavigation(navBtn, nav, navBody);
			var flag = true;
  ...
  */
	{
		(function () {
			...
			var slid = new sd_slideshow(7500);
